...
public class Main {
    public static void main(String[] args) {
        ...
        while (game) {
            ...
            // Проверяем, есть ли шах и мат
            if (board.Check('w')) {
                System.out.println("Шах для белых!");

                if (board.Mate()) {
                    System.out.println("Мат для белых!");
                    game=false;

                }
            }
            if (board.Check('b')) {
                System.out.println("Шах для черных!");

                if (board.Mate()) {
                    System.out.println("Мат для черных!");
                    game=false;
